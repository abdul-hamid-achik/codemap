...
│                              #   (graphs) · annotations (knowledge layer) · staleness (drift)
│                              #   · index_progress (TTY bar) · studio (TUI+gopls)
...
- Tool names are `codemap_`-prefixed. Current set (19): `init, index, status, doctor, semantic,
